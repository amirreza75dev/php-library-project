...
if ($referrer === 'employee' && $isEmployeeLoggedIn) {
    header('Location: employee.php'); // Change 'homepage.php' to the desired destination page
    exit();
}
if ($referrer === 'client' && $isClientLoggedIn) {
    header('Location: client.php'); // Change 'homepage.php' to the desired destination page
    exit();
}
